...
from PyQt5.QtWidgets import QMainWindow, QApplication,QComboBox, QLabel, QPushButton, QTableView, QProgressBar
...
class UI(QMainWindow):
	...
	def __init__(self):
		...
		self.progressBar1.setStyleSheet("QProgressBar::chunk{ background-color: Cyan; } QProgressBar {color: Black;}")
	...
	def clickerPressedStopJammer(self):
		print("stopJammer executed")
		print("from mainwindow "+str(LogicFunctions.proc.pid))	
...
#apply_stylesheet(app,theme='dark_lightreen.xml')
UIWindow=UI()
app.exec_()